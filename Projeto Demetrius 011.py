...
lista_produtos = [['Mouse', 45.0, 21], ['Teclado', 89.0, 18], ['Tablet', 890.0, 12], ['Monitor', 1050.0, 8], ['Pendrive', 95, 30],
                  ['Celular', 1600, 10], ['Projetor', 3500, 5], ['Notebook', 3200, 12], ['Roteador', 205, 20], ['Desktop', 2900, 10]]
...
def relatorio_vendas(vendas_realizadas):
    ...
    for venda in vendas_realizadas:
        ...
        total_do_dia += total
        total_de_impostos += impostos
        total_de_comissao += comissao
    ...
    print(f'{"TOTAL EM VENDAS":<38}R$ {total_do_dia:>6.2f}')
    print(f'{"TOTAL EM IMPOSTOS":<38}R$ {total_de_impostos:>6.2f}')
    print(f'{"TOTAL EM COMISSÕES":<38}R$ {total_de_comissao:>6.2f}')
    print('=' * 60)
...
while not sair:
    ...
    try:
        ...
        print('Valor inválido. Por favor, digite um número inteiro da lista.')
    ...
    # 4 Caso Escolha Realizar Compras
        ...
        while True:
            ...
            try:
                ...
                if prod < 1 or prod > len(lista_produtos):
                    raise IndexError
            except ValueError:
                print('Valor inválido. Por favor, digite um número inteiro da lista.')
                continue
            except IndexError:
                print('Número inválido. Por favor, escolha um número de produto válido da lista.')
                continue
            ...
            while True:
                try:
                    ...
                    if quant <= lista_produtos[prod-1][2]:
                        break
                    # Verifica se a quantidade pedido é maior que a quantidade em estoque.
                    # Se for, dá a informação e pede novamente pra escolher a quantidade.
                    if quant > lista_produtos[prod-1][2]:
                        raise IndexError
                except ValueError:
                    sleep(0.5)
                    ...
                    sleep(0.5)
                    print('Número inválido. A quantidade escolhida é maior que a quantidade que temos em estoque. Tente novamente.')
                    print('-' * 35)
                    continue
            ...
            if parar in 'Nn':
                ...
                if parar2 == 2:
                    ...
                    if pagar in 'Ss':
                        ...
                        # Adiciona venda à lista de vendas realizadas (relatório de venda)
    ...
    # 8 Caso Escolha um número fora das opções
    else:
